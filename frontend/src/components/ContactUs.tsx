...
const ContactUs = () => {
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            ...
            if (!resp.ok) {
                ...
                throw new Error(
                    `Server responded ${resp.status} - ${JSON.stringify(body)}`
                );
            }
    ...
    return (
        <section
            id="contact"
            className="py-16 md:py-24 bg-gradient-to-b from-background to-background/80"
        >
                ...
                <div className="max-w-2xl mx-auto">
                    ...
                    <div className="text-center mb-12">
                        ...
                        <p className="text-muted-foreground text-lg">
                            Have questions about DarkCode Rising? We'd love to
                            hear from you. Send us a message and we'll get back
